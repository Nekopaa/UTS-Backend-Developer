...
<div class="max-w-2xl mx-auto">
    ...
    <div class="neo-brutal-card p-8 bg-white space-y-6">
        <div class="border-b border-slate-100 pb-4">
            <h3 class="text-xl font-extrabold text-slate-850">Formulir Perbarui Data Pelanggan</h3>
            <p class="text-xs font-semibold text-slate-500 mt-1">Ubah informasi pelanggan yang terdaftar.</p>
        </div>

        <form action="{{ route('pelanggan.update', $pelanggan->id_pelanggan) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <select id="jenis_pelanggan" name="jenis_pelanggan" class="neo-brutal-input" required>
                        ...
                        <option value="lembaga" {{ old('jenis_pelanggan', $pelanggan->jenis_pelanggan) === 'lembaga' ? 'selected' : '' }}>Lembaga / Instansi</option>
                    </select>
            ...
            <div class="space-y-2">
                ...
                <input type="text" id="nama_pelanggan" name="nama_pelanggan" class="neo-brutal-input" value="{{ old('nama_pelanggan', $pelanggan->nama_pelanggan) }}" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" id="nama_lembaga" name="nama_lembaga" class="neo-brutal-input" value="{{ old('nama_lembaga', $pelanggan->nama_lembaga) }}" placeholder="Isi jika jenis pelanggan Lembaga">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="penanggung_jawab" name="penanggung_jawab" class="neo-brutal-input" value="{{ old('penanggung_jawab', $pelanggan->penanggung_jawab) }}" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" id="no_telepon" name="no_telepon" class="neo-brutal-input" value="{{ old('no_telepon', $pelanggan->no_telepon) }}" required>
                ...
                <div class="space-y-2">
                    ...
                    <input type="email" id="email" name="email" class="neo-brutal-input" value="{{ old('email', $pelanggan->email) }}">
            ...
            <div class="space-y-2">
                ...
                <textarea id="alamat" name="alamat" rows="3" class="neo-brutal-input" required>{{ old('alamat', $pelanggan->alamat) }}</textarea>
            ...
            <div class="space-y-2">
                ...
                <input type="date" id="tanggal_daftar" name="tanggal_daftar" class="neo-brutal-input" value="{{ old('tanggal_daftar', $pelanggan->tanggal_daftar ? \Carbon\Carbon::parse($pelanggan->tanggal_daftar)->format('Y-m-d') : '') }}" required>
