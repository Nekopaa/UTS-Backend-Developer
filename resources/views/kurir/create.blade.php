...
<div class="max-w-2xl mx-auto">
    ...
    <div class="neo-brutal-card p-8 bg-white space-y-6">
        <div class="border-b border-slate-100 pb-4">
            <h3 class="text-xl font-extrabold text-slate-850">Formulir Tambah Armada Kurir</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <select id="status_kurir" name="status_kurir" class="neo-brutal-input" required>
                        ...
                        <option value="nonaktif" {{ old('status_kurir') === 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                    </select>
